...
class MainViewModel(QObject):
    ...
    def __init__(self, plc_service: PLCService):
        ...
        예:
            VM : 재난 채널(system_error)에 주파수를 맞춰놓음
            S  : 방송국(EventBus)의 재난 채널(system_error)에 대고 소리침
        ...
        # system_error 에서 방송 나오면 _handle_system_error 한테 일 시킴
        EVENT_BUS.system_error.connect(self._handle_system_error)

...
class ServoControlViewModel(QObject):
    ...
    def start_manual(self, data: dict[str, float]):
        ...
        try:
            ...
            self._plc_service.move_robot_by_pose(data)
    ...
    def stop_manual(self):
        ...
        try:
            ...
            self._plc_service.emergency_stop_all()
        except Exception as e:
    ...
    def home_manual(self):
        ...
        try:
            ...
            self._plc_service.homing(3)
            # 툴(1, 2)도 필요 시 추가
            self._plc_service.homing(1)
            self._plc_service.homing(2)
        except Exception as e:
